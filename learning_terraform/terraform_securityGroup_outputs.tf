...
output "public_bastion_sg_group_id" {
  ...
  value = module.sg-bastion-public.this_security_group_id
}
...
output "public_bastion_sg_group_name" {
  ...
  value       = module.sg-bastion-public.this_security_group_name
}
...
output "private_sg_group_vpc_id" {
  description = "The VPC ID"
  value       = module.security-group-private.this_security_group_vpc_id
}
